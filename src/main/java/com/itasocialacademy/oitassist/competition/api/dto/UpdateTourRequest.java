...
public record UpdateTourRequest(
    @Schema(description = "Title of the tour", example = "Оновлений Тур", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank
    String title,

    @Schema(description = "Description of the tour", example = "Новий детальний опис туру")
    String description,
    ...
    @Schema(description = "Location for the tour", example = "Konotop city", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank
    String location,
