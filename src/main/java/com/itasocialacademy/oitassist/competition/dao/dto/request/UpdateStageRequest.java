...
public record UpdateStageRequest(
    @Schema(description = "Title of the stage", example = "Оновлений Етап", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank
    String title,

    @Schema(description = "Description of the stage", example = "Новий детальний опис")
    String description,
    ...
    @Schema(description = "Scope of the stage", example = "NATIONAL", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull
    StageScope scope,
