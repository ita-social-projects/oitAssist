...
public record OfficialAnswerPublishedDomainEvent(
    ...
    public OfficialAnswerPublishedDomainEvent {
        Objects.requireNonNull(question, "Answered question snapshot must not be null");
        Objects.requireNonNull(message, "Official answer snapshot must not be null");
        ...
        Objects.requireNonNull(occurredAt, "Official answer publication time must not be null");
