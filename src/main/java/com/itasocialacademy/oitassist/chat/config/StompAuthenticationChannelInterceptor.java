...
public class StompAuthenticationChannelInterceptor implements ChannelInterceptor {
    ...
    private static final String INVALID_AUTHENTICATION = "Invalid STOMP authentication";
    ...
    private void authenticate(StompHeaderAccessor accessor) {
        ...
        Authentication authentication = stompAuthenticationFacade.authenticateAccessToken(accessToken);
        accessor.setUser(authentication);
    }

    private static BadCredentialsException invalidAuthentication() {
        return new BadCredentialsException(INVALID_AUTHENTICATION);
    }
}