...
public interface ParticipantQuestionService {
    ...
    /**
     * Retrieves a page of messages belonging to a question visible to the
     * current user.
     *
     * <p>Messages are returned in deterministic chronological order using
     * {@code createdAt ASC, id ASC}.</p>
     *
     * @param questionId identifier of the requested question thread
     ...
     *
     * <p>The authenticated user becomes the message author. The question
     * reference, author, message type, identifier and creation timestamp are
     * controlled by the backend. The persisted message type is always
     * {@code COMMENT}.</p>
     *
