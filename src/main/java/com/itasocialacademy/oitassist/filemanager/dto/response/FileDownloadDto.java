 ...
 *
 * @param resource         the Spring {@link Resource} providing the file's byte stream
 * @param mimeType         the MIME media type of the file (e.g., {@code "application/pdf"})
 * @param originalFilename the original filename provided upon upload, used for Content-Disposition
