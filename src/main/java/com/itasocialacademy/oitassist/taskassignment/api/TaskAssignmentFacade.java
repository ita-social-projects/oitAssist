...
/**
 * Facade providing operations for managing task assignments from other modules.
 * Handles retrieval by id of task assignment entities. And simple check to see
 * if task has any assignments
 */
