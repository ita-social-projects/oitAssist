...
@Schema(description = "DTO representing full task assignment details")
public record DetailedTaskAssignmentResponseDTO(
    ...
    @Schema(
        ...
        example = "Cтворити у файлі-розв'язку на одному слайді ...") String taskDescription,
    ...
    @Schema(
        description = "Files attached to the task, filtered by user role") List<FileDetailsDTO> files,
