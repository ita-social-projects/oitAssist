...
public enum ErrorCode {
    ...
    PROFILE_UPDATE_REQUEST_ALREADY_REVIEWED(ErrorCategory.CONFLICT),

    INVITATION_INVALID_RESPONSE_STATUS(ErrorCategory.VALIDATION),
    INVITATION_ALREADY_RESPONDED(ErrorCategory.CONFLICT);
