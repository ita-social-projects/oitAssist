...
public enum ErrorCode {
    ...
    INVALID_TWO_FACTOR_CODE(ErrorCategory.AUTHENTICATION),
    TWO_FACTOR_VERIFICATION_LOCKED(ErrorCategory.RATE_LIMITED),
    TWO_FACTOR_ALREADY_ENABLED(ErrorCategory.CONFLICT),
    TWO_FACTOR_ENROLLMENT_NOT_FOUND(ErrorCategory.NOT_FOUND),
    ...
    INVALID_LOG_FILE_NAME(ErrorCategory.VALIDATION),
    LOG_FILE_NOT_FOUND(ErrorCategory.NOT_FOUND),
    LOG_FILE_DOWNLOAD_FAILED(ErrorCategory.TECHNICAL),
