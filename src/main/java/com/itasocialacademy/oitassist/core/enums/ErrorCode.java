...
public enum ErrorCode {
    ...
    QUESTION_ALREADY_CLAIMED(ErrorCategory.CONFLICT),

    FORUM_RESPONDER_INVALID(ErrorCategory.VALIDATION),
    FORUM_RESPONDER_ACCESS_RESTRICTED(ErrorCategory.AUTHORIZATION),
    FORUM_RESPONDER_ACTIVE_REVIEW_CONFLICT(ErrorCategory.CONFLICT),
