...
/**
 * Represents technical failures occurring while interacting with external
 * services.
 * <p>
 * Thrown when the application cannot successfully communicate with an external
 * system, such as a REST API, messaging service, or third-party SDK.
 * </p>
 *
 ...
 * <li>Typically mapped to HTTP 500 (Internal Server Error) in API
 * responses.</li>
 * </ul>
 *
 ...
 * can be included via the {@link Throwable#getCause()} mechanism. Additional
 * request/response context should be logged via MDC or audit logs.
 * </p>
 *
 * <h2>Usage</h2>
 * <ul>
 * <li>Use this exception to wrap failures when calling external services.</li>
 * <li>Do not use this exception for business rule violations or validation
 * errors.</li>
 * </ul>
 *
