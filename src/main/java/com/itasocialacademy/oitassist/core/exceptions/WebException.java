 ...
 * <p>
 * {@code WebException} represents errors that occur at the API / transport level
 * and are caused by an invalid, incomplete, or unauthorized client request.
 * These errors happen <b>before</b> or <b>outside</b> of business logic execution.
 * </p>
 *
 * <h2>Examples</h2>
 * <ul>
 ...
 * <ul>
 *   <li>Thrown from the <b>web layer</b> (controllers, filters, interceptors).</li>
 ...
 * <h2>HTTP mapping</h2>
 * <p>
 * Web exceptions are typically mapped to {@code 4xx} HTTP status codes
 * such as {@code 400}, {@code 401}, {@code 403}, or {@code 404},
 * depending on the associated {@link ErrorCode}.
 * </p>
 *
 * <p>
 * Mapping to HTTP response status codes is handled in the web layer
 ...
 *   <li>Prefer business exceptions once request data has been accepted as valid.</li>
 * </ul>
 *
 * @see AppException
