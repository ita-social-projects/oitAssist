 ...
 * <p>
 * Thrown when a requested resource, entity, or object does not exist in the
 * system according to business rules.
 * </p>
 *
 * <h2>Architectural role</h2>
 * <ul>
 * <li>Thrown from service or repository layers when a domain object cannot be
 * found.</li>
