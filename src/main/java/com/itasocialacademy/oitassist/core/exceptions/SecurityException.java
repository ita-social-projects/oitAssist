 ...
 * <p>
 * {@code SecurityException} indicates that an operation was rejected
 * due to insufficient permissions or invalid security context.
 * </p>
 *
 ...
 * <p>
 * Additional contextual information (e.g. user ID, IP address)
 * must be captured via logging or auditing mechanisms (e.g. MDC),
 * not stored directly in the exception instance.
 * </p>
 *
 * @see AppException
 * @see ErrorCode
