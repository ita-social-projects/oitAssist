 ...
 * <p>
 * {@code ValidationException} is used when input data is structurally valid
 * but violates business-level constraints or invariants.
 * </p>
 *
 * <h2>Important distinction</h2>
 * <p>
 * This exception is <b>not</b> intended for HTTP or request-level validation
 * (e.g. {@code @Valid}, missing headers, malformed parameters).
 * Such errors must be handled at the web layer and represented by
 * {@link WebException} subclasses.
 * </p>
 *
 * <h2>Examples</h2>
 * <ul>
 ...
 * <h2>HTTP mapping</h2>
 * <p>
 * Typically mapped to {@code 400 Bad Request}, but the exact status code
 * is determined by the associated {@link ErrorCode}.
 * </p>
 *
