 ...
 * <p>
 * {@code BusinessException} represents an error that occurs when a business
 * invariant, rule, or constraint is violated. These exceptions indicate
 * <b>expected</b> and <b>recoverable</b> failures from the perspective of the
 * application.
 * </p>
 *
 * <h2>Examples</h2>
 ...
 * <li>Does <b>not</b> represent technical failures or infrastructure
 * problems.</li>
 * </ul>
 *
 * <h2>HTTP mapping</h2>
 * <p>
 * Business exceptions are typically mapped to client error HTTP statuses such
 * as {@code 400}, {@code 403}, or {@code 404} depending on the associated
 * {@link ErrorCode}.
 * </p>
 *
 * <p>
 * The mapping to HTTP status codes is handled in the web layer (e.g.
